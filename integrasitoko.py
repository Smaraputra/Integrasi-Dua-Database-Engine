...
while (1):
    ...
    try:
        ...
        result = select(tables_1[0],cursor_toko)
        history = select(histories_1[0],cursor_toko)
        ...
        if(len(result) > len(history)):
            ...
            for data in result:
                ...
                if (a == 0):
                    ...
                    insert(tables_1[0],data,cursor_bank,db_bank)
        ...
        if(len(result) < len(history)):
            ...
            for dataHistory in history:
                ...
                if (a == 0):
                    ...
                    delete(tables_1[0],dataHistory,cursor_bank,db_bank)
                ...
                for dataHistory in history:
                    if (data[0] == dataHistory[0]):
                        if(data != dataHistory):
                            ...
                            update(tables_1[0],data,cursor_bank,db_bank)
